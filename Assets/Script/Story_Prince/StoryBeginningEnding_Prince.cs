...
public class StoryBeginningEnding_Prince : MonoBehaviour
{
    CanvasGroup canvasGroup;

    [Header("Musia")]
    public AudioSource BGM;
    public AudioClip plazaNowBGM, EndingBGM;
